...
namespace adria
{
    ...
    void Input::Tick()
    {
        ...
        if (Window::IsActive())
        {
			...
			keys[KeyCode::MouseLeft] = (::GetKeyState(VK_LBUTTON) & 0x8000) != 0;
			keys[KeyCode::MouseMiddle] = (::GetKeyState(VK_MBUTTON) & 0x8000) != 0;
			keys[KeyCode::MouseRight] = (::GetKeyState(VK_RBUTTON) & 0x8000) != 0;
