...
VS_OUTPUT main(VS_INPUT vin)
{
    ...
    model_matrix[3][0] += inverse_view[3][0];
    model_matrix[3][1] += inverse_view[3][1];
    model_matrix[3][2] += inverse_view[3][2];
    ...
    float4 PosH = mul(ViewPosition, projection); // + float4(vin.Pos.xy * dist, 0, 0)  float dist = ViewPosition.z;     
