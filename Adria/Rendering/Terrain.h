...
namespace adria
{
	...
	{
	public:
		Terrain(std::vector<TexturedNormalVertex> const& terrain_vertices, u64 tx, u64 tz, u64 xcount, u64 zcount)
			: terrain_vertices(terrain_vertices), tile_size_x(tx), tile_size_z(tz),
			  tile_count_x(xcount), tile_count_z(zcount), offset()
		{
		}

		f32 HeightAt(f32 x, f32 z) const //do bilinear interpolation
		{
			u64 x_1 = (u64)x / tile_size_x;
			u64 x_2 = (u64)((f64)x + tile_size_x) / tile_size_x;
			
			u64 z_1 = (u64)z / tile_size_z;
			u64 z_2 = (u64)((f64)z + tile_size_z) / tile_size_z;
