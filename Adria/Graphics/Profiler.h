...
namespace adria
{
	...
	#define SCOPED_PROFILE_BLOCK(profiler, context, block_id) ScopedProfileBlock block(profiler, context, block_id)
	#define SCOPED_PROFILE_BLOCK_ON_CONDITION(profiler, context, block_id, cond) std::unique_ptr<ScopedProfileBlock> scoped_profile = nullptr; \
