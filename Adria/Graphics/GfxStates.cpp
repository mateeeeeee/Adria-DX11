...
namespace adria
{
	...
	D3D11_RASTERIZER_DESC ConvertRasterizerDesc(GfxRasterizerState _rs)
	{
	...
	D3D11_DEPTH_STENCIL_DESC ConvertDepthStencilDesc(GfxDepthStencilState _dss)
	{
	...
	D3D11_BLEND_DESC ConvertBlendDesc(GfxBlendState _bd)
	{
		D3D11_BLEND_DESC bd{};
